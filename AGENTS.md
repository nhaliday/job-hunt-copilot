...
- **`resume-printer/`** — Markdown → PDF (+ DOCX for resumes) pipeline for
  ...
  [`resume-printer/AGENTS.md`](resume-printer/AGENTS.md).
...
- **`referral-prioritizer/`** — LinkedIn-connections referral pipeline (company
  ...
  [`referral-prioritizer/AGENTS.md`](referral-prioritizer/AGENTS.md). See
  [`job-description-scan/AGENTS.md`](job-description-scan/AGENTS.md).
